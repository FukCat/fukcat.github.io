/* jQuery v3.4.1 | (c) JS Foundation and other contributors | jquery.org/license */ ! function(a, b) {
    ...
    function cu(a) {
        return null == a ? a + "" : "object" == typeof a || "function" == typeof a ? bA[bG.call(a)] || "object" : typeof a
    }
    var aN = "3.4.1",
        bi = function(a, b) {
            return new bi.fn.init(a, b)
        }, bM = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g;
    ...
    bi.fn = bi.prototype = {
        ...
        get: function(a) {
            return null == a ? b4.call(this) : a < 0 ? this[a + this.length] : this[a]
        },
        pushStack: function(a) {
            var b = bi.merge(this.constructor(), a);
            return b.prevObject = this, b
        },
        each: function(a) {
            return bi.each(this, a)
        },
        map: function(a) {
            return this.pushStack(bi.map(this, function(b, c) {
                return a.call(b, c, b)
            }))
        },
        slice: function() {
            return this.pushStack(b4.apply(this, arguments))
        },
        first: function() {
            return this.eq(0)
        },
        ...
        var c, m, g, j, d, h, b = arguments[0] || {}, k = 1,
            p = arguments.length,
            f = !1;
        for ("boolean" == typeof b && (f = b, b = arguments[k] || {}, k++), "object" == typeof b || bu(b) || (b = {}), k === p && (b = this, k--); k < p; k++) {
            if (null != (c = arguments[k])) {
                for (m in c) {
                    j = c[m], "__proto__" !== m && b !== j && (f && j && (bi.isPlainObject(j) || (d = Array.isArray(j))) ? (g = b[m], h = d && !Array.isArray(g) ? [] : d || bi.isPlainObject(g) ? g : {}, d = !1, b[m] = bi.extend(f, h, j)) : void 0 !== j && (b[m] = j))
                }
            }
        }
        return b
        ...
        isPlainObject: function(a) {
            var c, b;
            return !(!a || "[object Object]" !== bG.call(a)) && (!(c = bY(a)) || "function" == typeof(b = cn.call(c, "constructor") && c.constructor) && ah.call(b) === bn)
        },
        ...
        makeArray: function(a, c) {
            var b = c || [];
            return null != a && (aB(Object(a)) ? bi.merge(b, "string" == typeof a ? [a] : a) : ch.call(b, a)), b
        },
        ...
        guid: 1,
        support: cG
    }), "function" == typeof Symbol && (bi.fn[Symbol.iterator] = ca[Symbol.iterator]), bi.each("Boolean Number String Function Array Date RegExp Object Error Symbol".split(" "), function(a, b) {
    ...
    var aZ = function(dv) {
        ...
        try {
            df.apply(dM = dz.call(ds.childNodes), ds.childNodes), dM[ds.childNodes.length].nodeType
        } catch (c3) {
            df = {
                apply: dM.length ? function(a, b) {
                    dq.apply(a, dz.call(b))
                } : function(a, d) {
                    var b = a.length,
                        c = 0;
                    while (a[b++] = d[c++]) {}
        ...
        function dL(y, g, m, w) {
            ...
            if (!w && ((g ? g.ownerDocument || g : ds) !== cX && dN(g), g = g || cX, c4)) {
                if (11 !== v && (z = d6.exec(y))) {
                    if (j = z[1]) {
                        if (9 === v) {
                            ...
                            if (h && (b = h.getElementById(j)) && d2(g, b) && b.id === j) {
                                return m.push(b), m
                            }
                        }
                    } else {
                        if (z[2]) {
                            return df.apply(m, g.getElementsByTagName(y)), m
                        }
                        if ((j = z[3]) && c0.getElementsByClassName && g.getElementsByClassName) {
                            return df.apply(m, g.getElementsByClassName(j)), m
                        }
                    }
                }
                if (c0.qsa && !cR[y + " "] && (!dT || !dT.test(y)) && (1 !== v || "object" !== g.nodeName.toLowerCase())) {
                    ...
                    try {
                        return df.apply(m, h.querySelectorAll(d)), m
                    } catch (g) {
                        cR(y, !0)
                    } finally {
                        x === dm && g.removeAttribute("id")
                    }
                }
            }
        ...
        function dS() {
            ...
            return function a(d, c) {
                return b.push(d + " ") > cT.cacheLength && delete a[b.shift()], a[d + " "] = c
            }
        }
        ...
        function cY(a) {
            var b = cX.createElement("fieldset");
            try {
                return !!a(b)
            } catch (a) {
                return !1
        ...
        function dc(a) {
            return function(b) {
                return "form" in b ? b.parentNode && !1 === b.disabled ? "label" in b ? "label" in b.parentNode ? b.parentNode.disabled === a : b.disabled === a : b.isDisabled === a || b.isDisabled !== !a && cS(b) === a : b.disabled === a : "label" in b && b.disabled === a
            }
        }
        ...
        for (c3 in c0 = dL.support = {}, dh = dL.isXML = function(a) {
            ...
            return c !== cX && 9 === c.nodeType && c.documentElement && (ct = (cX = c).documentElement, c4 = !dh(cX), ds !== cX && (b = cX.defaultView) && b.top !== b && (b.addEventListener ? b.addEventListener("unload", dA, !1) : b.attachEvent && b.attachEvent("onunload", dA)), c0.attributes = cY(function(f) {
                return f.className = "i", !f.getAttribute("className")
            }), c0.getElementsByTagName = cY(function(f) {
                return f.appendChild(cX.createComment("")), !f.getElementsByTagName("*").length
            }), c0.getElementsByClassName = dn.test(cX.getElementsByClassName), c0.getById = cY(function(f) {
                return ct.appendChild(f).id = dm, !cX.getElementsByName || !cX.getElementsByName(dm).length
            }), c0.getById ? (cT.filter.ID = function(f) {
                var g = f.replace(dO, dx);
                return function(h) {
                    return h.getAttribute("id") === g
                }
            }, cT.find.ID = function(f, h) {
                if ("undefined" != typeof h.getElementById && c4) {
                    var g = h.getElementById(f);
                    return g ? [g] : []
                }
            }) : (cT.filter.ID = function(f) {
                var g = f.replace(dO, dx);
                return function(h) {
                    var i = "undefined" != typeof h.getAttributeNode && h.getAttributeNode("id");
                    return i && i.value === g
                }
            }, cT.find.ID = function(f, l) {
            ...
            }), cT.find.TAG = c0.getElementsByTagName ? function(f, g) {
                return "undefined" != typeof g.getElementsByTagName ? g.getElementsByTagName(f) : c0.qsa ? g.querySelectorAll(f) : void 0
            } : function(f, l) {
                var h, k = [],
                    g = 0,
            ...
            })), (c0.matchesSelector = dn.test(cW = ct.matches || ct.webkitMatchesSelector || ct.mozMatchesSelector || ct.oMatchesSelector || ct.msMatchesSelector)) && cY(function(f) {
                c0.disconnectedMatch = cW.call(f, "*"), cW.call(f, "[s!='']:x"), dJ.push("!=", at)
            }), dT = dT.length && new RegExp(dT.join("|")), dJ = dJ.length && new RegExp(dJ.join("|")), d = dn.test(ct.compareDocumentPosition), d2 = d || dn.test(ct.contains) ? function(f, i) {
                ...
                return g || (1 & (g = (f.ownerDocument || f) === (h.ownerDocument || h) ? f.compareDocumentPosition(h) : 1) || !c0.sortDetached && h.compareDocumentPosition(f) === g ? f === cX || f.ownerDocument === ds && d2(ds, f) ? -1 : h === cX || h.ownerDocument === ds && d2(ds, h) ? 1 : dQ ? dC(dQ, f) - dC(dQ, h) : 0 : 4 & g ? -1 : 1)
            } : function(g, p) {
                if (g === p) {
                    return dp = !0, 0
                }
                var j, l = 0,
                    ...
                    m = [p];
                if (!h || !k) {
                    return g === cX ? -1 : p === cX ? 1 : h ? -1 : k ? 1 : dQ ? dC(dQ, g) - dC(dQ, p) : 0
                }
                if (h === k) {
                    return dD(g, p)
                }
        ...
        }, dL.matches = function(a, b) {
            return dL(a, null, null, b)
        }, dL.matchesSelector = function(a, c) {
            if ((a.ownerDocument || a) !== cX && dN(a), c0.matchesSelector && c4 && !cR[c + " "] && (!dJ || !dJ.test(c)) && (!dT || !dT.test(c))) {
                try {
                    var b = cW.call(a, c);
                    if (b || c0.disconnectedMatch || a.document && 11 !== a.document.nodeType) {
                        return b
                    }
                } catch (a) {
                    cR(c, !0)
            ...
            return 0 < dL(c, cX, null, [a]).length
        }, dL.contains = function(a, b) {
            return (a.ownerDocument || a) !== cX && dN(a), d2(a, b)
        }, dL.attr = function(a, d) {
        ...
        }, dL.escape = function(a) {
            return (a + "").replace(dI, dj)
        }, dL.error = function(a) {
            throw new Error("Syntax error, unrecognized expression: " + a)
        }, dL.uniqueSort = function(a) {
            var f, c = [],
                d = 0,
                b = 0;
            if (dp = !c0.detectDuplicates, dQ = !c0.sortStable && a.slice(0), a.sort(c1), dp) {
                while (f = a[b++]) {
                    f === a[b] && (d = c.push(b))
                }
                while (d--) {
            ...
            preFilter: {
                ATTR: function(a) {
                    return a[1] = a[1].replace(dO, dx), a[3] = (a[3] || a[4] || a[5] || "").replace(dO, dx), "~=" === a[2] && (a[3] = " " + a[3] + " "), a.slice(0, 4)
                },
                CHILD: function(a) {
                    return a[1] = a[1].toLowerCase(), "nth" === a[1].slice(0, 3) ? (a[3] || dL.error(a[0]), a[4] = +(a[4] ? a[5] + (a[6] || 1) : 2 * ("even" === a[3] || "odd" === a[3])), a[5] = +(a[7] + a[8] || "odd" === a[3])) : a[3] && dL.error(a[0]), a
                },
                PSEUDO: function(a) {
                    var c, b = !a[6] && a[2];
                    return db.CHILD.test(a[0]) ? null : (a[3] ? a[2] = a[4] || a[5] || "" : b && d0.test(b) && (c = dd(b, !0)) && (c = b.indexOf(")", b.length - c) - b.length) && (a[0] = a[0].slice(0, c), a[2] = b.slice(0, c)), a.slice(0, 3))
                }
            },
            filter: {
                TAG: function(a) {
                    var b = a.replace(dO, dx).toLowerCase();
                    return "*" === a ? function() {
                        return !0
                    } : function(c) {
                ...
                CLASS: function(a) {
                    var b = dB[a + " "];
                    return b || (b = new RegExp("(^|" + dt + ")" + a + "(" + dt + "|$)")) && dB(a, function(c) {
                ...
                ATTR: function(b, c, a) {
                    return function(d) {
                        var f = dL.attr(d, b);
                        return null == f ? "!=" === c : !c || (f += "", "=" === c ? f === a : "!=" === c ? f !== a : "^=" === c ? a && 0 === f.indexOf(a) : "*=" === c ? a && -1 < f.indexOf(a) : "$=" === c ? a && f.slice(-a.length) === a : "~=" === c ? -1 < (" " + f.replace(c8, " ") + " ").indexOf(a) : "|=" === c && (f === a || f.slice(0, a.length + 1) === a + "-"))
                    }
                },
                    ...
                    return 1 === b && 0 === i ? function(g) {
                        ...
                        if (h) {
                            ...
                            if (E = [d ? h.firstChild : h.lastChild], d && A) {
                                m = (C = (B = (w = (z = (g = h)[dm] || (g[dm] = {}))[g.uniqueID] || (z[g.uniqueID] = {}))[c] || [])[0] === dK && B[1]) && B[2], g = C && h.childNodes[C];
                                ...
                                if (A && (m = C = (B = (w = (z = (g = q)[dm] || (g[dm] = {}))[g.uniqueID] || (z[g.uniqueID] = {}))[c] || [])[0] === dK && B[1]), !1 === m) {
                                    while (g = ++C && g && g[x] || (m = C = 0) || E.pop()) {
                                        if ((j ? g.nodeName.toLowerCase() === v : 1 === g.nodeType) && ++m && (A && ((w = (z = g[dm] || (g[dm] = {}))[g.uniqueID] || (z[g.uniqueID] = {}))[c] = [dK, m]), g === q)) {
                                            break
                                        }
                                    }
                                }
            ...
            pseudos: {
                ...
                has: dr(function(a) {
                    return function(b) {
                        return 0 < dL(a, b).length
                    }
                }),
                contains: dr(function(a) {
                    return a = a.replace(dO, dx),
                    function(b) {
                        return -1 < (b.textContent || dy(b)).indexOf(a)
                    }
                }),
                lang: dr(function(a) {
                    ...
                    function(b) {
                        var c;
                        do {
                            if (c = c4 ? b.lang : b.getAttribute("xml:lang") || b.getAttribute("lang")) {
                ...
                target: function(a) {
                    var b = dv.location && dv.location.hash;
                ...
                focus: function(a) {
                    return a === cX.activeElement && (!cX.hasFocus || cX.hasFocus()) && !! (a.type || a.href || ~a.tabIndex)
                },
                enabled: dc(!1),
                disabled: dc(!0),
                checked: function(a) {
                ...
                parent: function(a) {
                    return !cT.pseudos.empty(a)
                },
                header: function(a) {
                    return dl.test(a.nodeName)
                },
                input: function(a) {
                    return dF.test(a.nodeName)
                },
                button: function(a) {
                    var b = a.nodeName.toLowerCase();
                ...
                last: dV(function(a, b) {
                    return [b - 1]
                }),
                eq: dV(function(a, c, b) {
                    return [b < 0 ? b + c : b]
                }),
                even: dV(function(a, c) {
                    for (var b = 0; b < c; b += 2) {
                        a.push(b)
                    }
                    return a
                ...
                lt: dV(function(a, d, b) {
                    for (var c = b < 0 ? b + d : d < b ? d : b; 0 <= --c;) {
                        a.push(c)
                    }
                    return a
                }),
                gt: dV(function(a, d, b) {
        ...
        function cV(i, b, j) {
            ...
            return b.first ? function(c, l, f) {
                ...
                if (m) {
                    ...
                    while (f = f[k]) {
                        if (1 === f.nodeType || d) {
                            if (l = (p = f[dm] || (f[dm] = {}))[f.uniqueID] || (p[f.uniqueID] = {}), g && g === f.nodeName.toLowerCase()) {
                                f = f[k] || f
                            } else {
                                if ((q = l[a]) && q[0] === dK && q[1] === h) {
                                    return c[2] = q[2]
                                }
                                if ((l[a] = c)[2] = i(f, s, m)) {
                                    return !0
        ...
        function cZ(a, f, c, i, j, b) {
            return i && !i[dm] && (i = cZ(i)), j && !j[dm] && (j = cZ(j, b)), dr(function(h, A, v, y) {
                ...
                if (h) {
                    ...
                    x = dP(x === A ? x.splice(q, x.length) : x), j ? j(null, A, x, y) : df.apply(A, x)
                }
            })
        }

        function c6(f) {
            for (var g, q, j, m = f.length, k = cT.relative[f[0].type], b = k || cT.relative[" "], p = k ? 1 : 0, v = cV(function(a) {
                    return a === g
                }, b, !0), h = cV(function(a) {
                    return -1 < dC(g, a)
                }, b, !0), d = [
                    function(a, l, c) {
                        var i = !k && (c || l !== dW) || ((g = l).nodeType ? v(a, l, c) : h(a, l, c));
                        return g = null, i
                    }
                ]; p < m; p++) {
                if (q = cT.relative[f[p].type]) {
                    d = [cV(dY(d), q)]
                } else {
                    if ((q = cT.filter[f[p].type].apply(null, f[p].matches))[dm]) {
                        for (j = ++p; j < m; j++) {
                            if (cT.relative[f[j].type]) {
                                break
                            }
                        }
                        return cZ(1 < p && dY(d), 1 < p && d1(f.slice(0, p - 1).concat({
                            value: " " === f[p - 2].type ? "*" : ""
                        })).replace(cU, "$1"), q, p < j && c6(f.slice(p, j)), j < m && c6(f = f.slice(j)), j < m && d1(f))
                    }
                    d.push(q)
                }
            }
        ...
        return du.prototype = cT.filters = cT.pseudos, cT.setFilters = new du, dd = dL.tokenize = function(c, m) {
            ...
            while (b) {
                for (h in g && !(j = bt.exec(b)) || (j && (b = b.slice(j[0].length) || b), k.push(d = [])), g = !1, (j = d5.exec(b)) && (g = j.shift(), d.push({
                    value: g,
                    type: j[0].replace(cU, " ")
                }), b = b.slice(g.length)), cT.filter) {
                    !(j = db[h].exec(b)) || p[h] && !(j = p[h](j)) || (g = j.shift(), d.push({
                        value: g,
                        type: h,
                        matches: j
                    }), b = b.slice(g.length))
            ...
            if (j = j || [], 1 === d.length) {
                if (2 < (k = d[0] = d[0].slice(0)).length && "ID" === (b = k[0]).type && 9 === q.nodeType && c4 && cT.relative[k[1].type]) {
                    if (!(q = (cT.find.ID(b.matches[0].replace(dO, dx), q) || [])[0])) {
                        return j
                    }
                ...
                while (g--) {
                    if (b = k[g], cT.relative[p = b.type]) {
                        break
                    }
                    if ((v = cT.find[p]) && (m = v(b.matches[0].replace(dO, dx), c5.test(k[0].type) && d4(q.parentNode) || q))) {
                        if (k.splice(g, 1), !(f = m.length && d1(k))) {
                            return df.apply(j, m), j
                        }
                        break
                    }
                }
        ...
        }, c0.sortStable = dm.split("").sort(c1).join("") === dm, c0.detectDuplicates = !! dp, dN(), c0.sortDetached = cY(function(a) {
            return 1 & a.compareDocumentPosition(cX.createElement("fieldset"))
        }), cY(function(a) {
            return a.innerHTML = "<a href='#'></a>", "#" === a.firstChild.getAttribute("href")
        }) || c9("type|href|height|width", function(a, c, b) {
            if (!b) {
                return a.getAttribute(c, "type" === c.toLowerCase() ? 1 : 2)
            }
        }), c0.attributes && cY(function(a) {
            return a.innerHTML = "<input/>", a.firstChild.setAttribute("value", ""), "" === a.firstChild.getAttribute("value")
        }) || c9("value", function(a, c, b) {
            if (!b && "input" === a.nodeName.toLowerCase()) {
                return a.defaultValue
            }
        }), cY(function(a) {
            return null == a.getAttribute("disabled")
        }) || c9(dH, function(a, d, b) {
            var c;
            if (!b) {
    ...
    function bb(a, b, c) {
        return bu(b) ? bi.grep(a, function(d, f) {
            return !!b.call(d, f, d) !== c
        }) : b.nodeType ? bi.grep(a, function(d) {
            return d === b !== c
        }) : "string" != typeof b ? bi.grep(a, function(d) {
            return -1 < a5.call(b, d) !== c
        }) : bi.filter(b, a, c)
    }
    bi.filter = function(a, d, b) {
        var c = d[0];
        return b && (a = ":not(" + a + ")"), 1 === d.length && 1 === c.nodeType ? bi.find.matchesSelector(c, a) ? [c] : [] : bi.find.matches(a, bi.grep(d, function(f) {
            return 1 === f.nodeType
        }))
    }, bi.fn.extend({
        find: function(a) {
            var f, c, d = this.length,
                b = this;
            if ("string" != typeof a) {
                return this.pushStack(bi(a).filter(function() {
                    for (f = 0; f < d; f++) {
                        if (bi.contains(b[f], this)) {
                            return !0
                        }
                    }
                }))
        ...
        is: function(a) {
            return !!bb(this, "string" == typeof a && bB.test(a) ? bi(a) : a || [], !1).length
        }
    });
    var bS, bo = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    (bi.fn.init = function(a, f, c) {
        ...
        if (c = c || bS, "string" == typeof a) {
            if (!(d = "<" === a[0] && ">" === a[a.length - 1] && 3 <= a.length ? [null, a, null] : bo.exec(a)) || !d[1] && f) {
                return !f || f.jquery ? (f || c).find(a) : this.constructor(f).find(a)
            }
            if (d[1]) {
                if (f = f instanceof bi ? f[0] : f, bi.merge(this, bi.parseHTML(d[1], f && f.nodeType ? f.ownerDocument || f : aI, !0)), aC.test(d[1]) && bi.isPlainObject(f)) {
                    for (d in f) {
                        bu(this[d]) ? this[d](f[d]) : this.attr(d, f[d])
                    }
                }
                return this
            }
        ...
        return a.nodeType ? (this[0] = a, this.length = 1, this) : bu(a) ? void 0 !== c.ready ? c.ready(a) : a(bi) : bi.makeArray(a, this)
    }).prototype = bi.fn, bS = bi(aI);
    ...
    bi.fn.extend({
            ...
            if (!bB.test(c)) {
                for (; h < d; h++) {
                    for (f = this[h]; f && f !== j; f = f.parentNode) {
                        if (f.nodeType < 11 && (b ? -1 < b.index(f) : 1 === f.nodeType && bi.find.matchesSelector(f, c))) {
                            g.push(f);
                            break
                        }
                    }
        ...
        index: function(a) {
            return a ? "string" == typeof a ? a5.call(bi(a), this[0]) : a5.call(this, a.jquery ? a[0] : a) : this[0] && this[0].parentNode ? this.first().prevAll().length : -1
        },
        add: function(a, b) {
            return this.pushStack(bi.uniqueSort(bi.merge(this.get(), bi(a, b))))
        },
        addBack: function(a) {
        ...
        parents: function(a) {
            return cb(a, "parentNode")
        },
        parentsUntil: function(a, c, b) {
            return cb(a, "parentNode", b)
        },
        next: function(a) {
            return bN(a, "nextSibling")
        },
        prev: function(a) {
            return bN(a, "previousSibling")
        },
        nextAll: function(a) {
            return cb(a, "nextSibling")
        },
        prevAll: function(a) {
            return cb(a, "previousSibling")
        },
        nextUntil: function(a, c, b) {
            return cb(a, "nextSibling", b)
        },
        prevUntil: function(a, c, b) {
            return cb(a, "previousSibling", b)
        },
        siblings: function(a) {
            return b5((a.parentNode || {}).firstChild, a)
        },
        children: function(a) {
            return b5(a.firstChild)
        },
        contents: function(a) {
            return "undefined" != typeof a.contentDocument ? a.contentDocument : (ai(a, "template") && (a = a.content || a), bi.merge([], a.childNodes))
        }
    }, function(b, a) {
        bi.fn[b] = function(c, f) {
            var d = bi.map(this, a, c);
            return "Until" !== b.slice(-5) && (f = c), f && "string" == typeof f && (d = bi.filter(f, d)), 1 < this.length && (bH[b] || bi.uniqueSort(d), a0.test(b) && d.reverse()), this.pushStack(d)
        }
    });
    var bZ = /[^\x20\t\r\n\f]+/g;
    ...
    function cv(a, f, c, d) {
        var b;
        try {
            a && bu(b = a.promise) ? b.call(a).done(f).fail(c) : a && bu(b = a.then) ? b.call(a, f, c) : f.apply(void 0, [a].slice(d))
        } catch (a) {
            c.apply(void 0, [a])
        }
    }
    bi.Callbacks = function(q) {
        var g, m;
        q = "string" == typeof q ? (g = q, m = {}, bi.each(g.match(bZ) || [], function(a, c) {
            m[c] = !0
        }), m) : bi.extend({}, q);
        var j, w, p, b, v = [],
            x = [],
            ...
            d = function() {
                ...
                add: function() {
                    return v && (w && !j && (k = v.length - 1, x.push(w)), function a(c) {
                        bi.each(c, function(f, i) {
                            bu(i) ? q.unique && h.has(i) || v.push(i) : i && i.length && "string" !== cu(i) && a(i)
                        })
                    }(arguments), w && !j && d()), this
                },
                remove: function() {
                    return bi.each(arguments, function(a, f) {
                        var c;
                        while (-1 < (c = bi.inArray(f, v, c))) {
                            v.splice(c, 1), c <= k && k--
                        }
                    }), this
                },
                has: function(a) {
                    return a ? -1 < bi.inArray(a, v) : 0 < v.length
                },
                empty: function() {
                    return v && (v = []), this
                },
                                ...
                                var p = this,
                                    ...
                                    o = function() {
                                        ...
                                        try {
                                            ...
                                            bi.Deferred.exceptionHook && bi.Deferred.exceptionHook(r, s.stackTrace), j <= l + 1 && (k !== a6 && (p = void 0, q = [r]), m.rejectWith(p, q))
                                        }
                                    };
                                l ? s() : (bi.Deferred.getStackHook && (s.stackTrace = bi.Deferred.getStackHook()), aw.setTimeout(s))
                            }
                        }
                        return bi.Deferred(function(k) {
                            f[0][3].add(a(0, k, bu(h) ? h : bv, k.notifyWith)), f[1][3].add(a(0, k, bu(i) ? i : bv)), f[2][3].add(a(0, k, bu(e) ? e : a6))
                        }).promise()
                    },
                    promise: function(a) {
                        return null != a ? bi.extend(a, b) : b
                    }
                }, g = {};
        ...
        when: function(c) {
            var f = arguments.length,
                ...
                b = function(a) {
                    return function(i) {
                        h[a] = this, d[a] = 1 < arguments.length ? b4.call(arguments) : i, --f || g.resolveWith(h, d)
                    }
                };
            if (f <= 1 && (cv(c, g.done(b(j)).resolve, g.reject, !f), "pending" === g.state() || bu(d[j] && d[j].then))) {
                return g.then()
            }
            while (j--) {
                cv(d[j], b(j), g.reject)
    ...
    bi.Deferred.exceptionHook = function(a, b) {
        aw.console && aw.console.warn && a && aa.test(a.name) && aw.console.warn("jQuery.Deferred exception: " + a.message, a.stack, b)
    }, bi.readyException = function(a) {
    ...
    function ao() {
        aI.removeEventListener("DOMContentLoaded", ao), aw.removeEventListener("load", ao), bi.ready()
    }
    bi.fn.ready = function(a) {
    ...
    var ad = function(c, m, g, j, d, h, b) {
        ...
        if ("object" === cu(g)) {
            ...
            if (void 0 !== j && (d = !0, bu(j) || (b = !0), f && (b ? (m.call(c, j), m = null) : (f = m, m = function(a, l, i) {
                return f.call(bi(a), i)
            })), m)) {
                for (; k < p; k++) {
    ...
    function co(a) {
        return a.replace(cM, "ms-").replace(ci, cB)
    }
    var aU = function(a) {
    ...
    function cH() {
        this.expando = bi.expando + cH.uid++
    }
    cH.uid = 1, cH.prototype = {
        cache: function(a) {
            var b = a[this.expando];
            return b || (b = {}, aU(a) && (a.nodeType ? a[this.expando] = b : Object.defineProperty(a, this.expando, {
                value: b,
                configurable: !0
            }))), b
        },
        ...
        get: function(a, b) {
            return void 0 === b ? this.cache(a) : a[this.expando] && a[this.expando][co(b)]
        },
        ...
        remove: function(a, d) {
            ...
            if (void 0 !== c) {
                if (void 0 !== d) {
                    b = (d = Array.isArray(d) ? d.map(co) : (d = co(d)) in c ? [d] : d.match(bZ) || []).length;
                    while (b--) {
                        delete c[d[b]]
                    }
                }(void 0 === d || bi.isEmptyObject(c)) && (a.nodeType ? a[this.expando] = void 0 : delete a[this.expando])
            }
        },
        hasData: function(a) {
            var b = a[this.expando];
            return void 0 !== b && !bi.isEmptyObject(b)
        }
    };
    var bT = new cH,
        bc = new cH,
    ...
    function aJ(a, f, c) {
        ...
        if (void 0 === c && 1 === a.nodeType) {
            if (d = "data-" + f.replace(cN, "-$&").toLowerCase(), "string" == typeof(c = a.getAttribute(d))) {
                try {
                    c = "true" === (b = c) || "false" !== b && ("null" === b ? null : b === +b + "" ? +b : bj.test(b) ? JSON.parse(b) : b)
                } catch (a) {}
                bc.set(a, f, c)
            } else {
                c = void 0
    ...
    bi.extend({
        hasData: function(a) {
            return bc.hasData(a) || bT.hasData(a)
        },
        data: function(a, c, b) {
        ...
        data: function(f, c) {
            ...
            if (void 0 === f) {
                if (this.length && (d = bc.get(g), 1 === g.nodeType && !bT.get(g, "hasDataAttrs"))) {
                    j = b.length;
                    while (j--) {
                        b[j] && 0 === (h = b[j].name).indexOf("data-") && (h = co(h.slice(5)), aJ(g, h, d[h]))
                    }
            ...
            return "object" == typeof f ? this.each(function() {
                ...
                var i;
                if (g && void 0 === a) {
                    return void 0 !== (i = bc.get(g, f)) ? i : void 0 !== (i = aJ(g, f)) ? i : void 0
                }
                this.each(function() {
                    bc.set(this, f, a)
                })
        ...
        queue: function(a, d, b) {
            var c;
            if (a) {
                return d = (d || "fx") + "queue", c = bT.get(a, d), b && (!c || Array.isArray(b) ? c = bT.access(a, d, bi.makeArray(b)) : c.push(b)), c || []
            }
        },
        ...
        _queueHooks: function(a, c) {
            var b = c + "queueHooks";
            return bT.get(a, b) || bT.access(a, b, {
                empty: bi.Callbacks("once memory").add(function() {
                    bT.remove(a, [c + "queue", b])
                })
            })
        }
    }), bi.fn.extend({
    ...
    var cc = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
        ...
        bI = function(a) {
            return bi.contains(a.ownerDocument, a)
        }, aj = {
            composed: !0
        };
    a7.getRootNode && (bI = function(a) {
        return bi.contains(a.ownerDocument, a) || a.getRootNode(aj) === a.ownerDocument
    });
    var b6 = function(a, b) {
        return "none" === (a = b || a).style.display || "" === a.style.display && bI(a) && "none" === bi.css(a, "display")
    }, cj = function(c, j, f, h) {
            var d, g, b = {};
            for (g in j) {
                b[g] = c.style[g], c.style[g] = j[g]
            }
            for (g in d = f.apply(c, h || []), j) {
                c.style[g] = b[g]
            }
            return d
        };
    ...
    function bp(f, q, j, m) {
        ...
        if (d && d[3] !== h) {
            v /= 2, h = h || d[3], d = +v || 1;
            while (b--) {
                bi.style(f, q, d + h), (1 - k) * (1 - (k = p() / v || 0.5)) <= 0 && (b = 0), d /= k
            }
    ...
    bi.fn.extend({
        ...
        toggle: function(a) {
            return "boolean" == typeof a ? a ? this.show() : this.hide() : this.each(function() {
                b6(this) ? bi(this).show() : bi(this).hide()
            })
        }
    });
    ...
    function cp(a, c) {
        var b;
        return b = "undefined" != typeof a.getElementsByTagName ? a.getElementsByTagName(c || "*") : "undefined" != typeof a.querySelectorAll ? a.querySelectorAll(c || "*") : [], void 0 === c || c && ai(a, c) ? bi.merge([a], b) : b
    }

    function cI(a, d) {
        for (var b = 0, c = a.length; b < c; b++) {
            bT.set(a[b], "globalEval", !d || bT.get(d[b], "globalEval"))
        }
    }
    ...
    function cw(k, C, x, A, v) {
        ...
        m.textContent = "", j = 0;
        while (y = z[j++]) {
            if (A && -1 < bi.inArray(y, A)) {
                v && v.push(y)
            } else {
                if (w = bI(y), b = cp(m.appendChild(y), "script"), w && cI(b), x) {
                    g = 0;
                    while (y = b[g++]) {
    ...
    function ak(c, k, f, h, d, g) {
        ...
        return 1 === g && (b = d, (d = function(a) {
            return bi().off(a), b.apply(this, arguments)
        }).guid = b.guid || (b.guid = bi.guid++)), c.each(function() {
            bi.event.add(this, k, d, h, f)
        })
    }
            ...
            handler: function(d) {
                ...
                if (1 & d.isTrigger && this[b]) {
                    if (g.length) {
                        ...
                        if (g = b4.call(arguments), bT.set(this, b, g), h = c(this, b), this[b](), g !== (f = bT.get(this, b)) || h ? bT.set(this, b, !1) : f = {}, g !== f) {
                            return d.stopImmediatePropagation(), d.preventDefault(), f.value
                        }
                    }
                } else {
                    g.length && (bT.set(this, b, {
                        value: bi.event.trigger(bi.extend(g[0], bi.Event.prototype), g.slice(1), this)
    ...
    bi.event = {
        ...
        add: function(F, m, A, D, y) {
            var B, b, E, G, z, j, q, C, k, x, w, H = bT.get(F);
            if (H) {
                A.handler && (A = (B = A).handler, y = B.selector), y && bi.find.matchesSelector(a7, y), A.guid || (A.guid = bi.guid++), (G = H.events) || (G = H.events = {}), (b = H.handle) || (b = H.handle = function(a) {
                    return "undefined" != typeof bi && bi.event.triggered !== a.type ? bi.event.dispatch.apply(F, arguments) : void 0
                }), z = (m = (m || "").match(bZ) || [""]).length;
                while (z--) {
                    k = w = (E = aK.exec(m[z]) || [])[1], x = (E[2] || "").split(".").sort(), k && (q = bi.event.special[k] || {}, k = (y ? q.delegateType : q.bindType) || k, q = bi.event.special[k] || {}, j = bi.extend({
                        type: k,
                        origType: w,
                        data: D,
                        handler: A,
                        guid: A.guid,
                        selector: y,
                        needsContext: y && bi.expr.match.needsContext.test(y),
                        namespace: x.join(".")
                    }, B), (C = G[k]) || ((C = G[k] = []).delegateCount = 0, q.setup && !1 !== q.setup.call(F, D, x, b) || F.addEventListener && F.addEventListener(k, b)), q.add && (q.add.call(F, j), j.handler.guid || (j.handler.guid = A.guid)), y ? C.splice(C.delegateCount++, 0, j) : C.push(j), bi.event.global[k] = !0)
                }
            }
        },
        ...
        dispatch: function(f) {
            ...
            for (v[0] = p, q = 1; q < arguments.length; q++) {
                v[q] = arguments[q]
            }
            if (p.delegateTarget = this, !d.preDispatch || !1 !== d.preDispatch.call(this, p)) {
                b = bi.event.handlers.call(this, p, h), q = 0;
                while ((g = b[q++]) && !p.isPropagationStopped()) {
                    p.currentTarget = g.elem, j = 0;
                    while ((k = g.handlers[j++]) && !p.isImmediatePropagationStopped()) {
                        p.rnamespace && !1 !== k.namespace && !p.rnamespace.test(k.namespace) || (p.handleObj = k, p.data = k.data, void 0 !== (m = ((bi.event.special[k.origType] || {}).handle || k.handler).apply(g.elem, v)) && !1 === (p.result = m) && (p.preventDefault(), p.stopPropagation()))
                    }
                }
        ...
        handlers: function(c, m) {
            ...
            if (p && f.nodeType && !("click" === c.type && 1 <= c.button)) {
                for (; f !== this; f = f.parentNode || this) {
                    if (1 === f.nodeType && ("click" !== c.type || !0 !== f.disabled)) {
                        for (h = [], b = {}, g = 0; g < p; g++) {
                            void 0 === b[d = (j = m[g]).selector + " "] && (b[d] = j.needsContext ? -1 < bi(d, this).index(f) : bi.find(d, this, null, [f]).length), b[d] && h.push(j)
                        }
                        h.length && k.push({
                            elem: f,
                            handlers: h
            ...
            return f = this, p < m.length && k.push({
                elem: f,
                handlers: m.slice(p)
            }), k
        },
        addProp: function(b, a) {
            Object.defineProperty(bi.Event.prototype, b, {
                enumerable: !0,
                configurable: !0,
                get: bu(a) ? function() {
        ...
        fix: function(a) {
            return a[bi.expando] ? a : new bi.Event(a)
        },
        special: {
            load: {
                noBubble: !0
            ...
            click: {
                setup: function(a) {
                    var b = this || a;
                    return bO.test(b.type) && b.click && ai(b, "input") && aE(b, "click", bk), !1
                },
                trigger: function(a) {
                    var b = this || a;
                    return bO.test(b.type) && b.click && ai(b, "input") && aE(b, "click"), !0
                },
                _default: function(a) {
                    var b = a.target;
                    return bO.test(b.type) && b.click && ai(b, "input") && bT.get(b, "click") || ai(b, "a")
                }
            },
            beforeunload: {
        ...
        which: function(a) {
            var b = a.button;
            return null == a.which && cd.test(a.type) ? null != a.charCode ? a.charCode : a.keyCode : !a.which && void 0 !== b && ay.test(a.type) ? 1 & b ? 1 : 2 & b ? 3 : 4 & b ? 2 : 0 : a.which
        }
    }, bi.event.addProp), bi.each({
        focus: "focusin",
        blur: "focusout"
    }, function(a, b) {
        bi.event.special[a] = {
            setup: function() {
                return aE(this, a, bD), !1
            },
            trigger: function() {
                return aE(this, a), !0
            },
        ...
        off: function(a, f, c) {
            ...
            if (a && a.preventDefault && a.handleObj) {
                return d = a.handleObj, bi(a.delegateTarget).off(d.namespace ? d.origType + "." + d.namespace : d.origType, d.selector, d.handler), this
            }
            if ("object" == typeof a) {
                for (b in a) {
                    this.off(b, f, a[b])
            ...
            return !1 !== f && "function" != typeof f || (c = f, f = void 0), !1 === c && (c = b7), this.each(function() {
                bi.event.remove(this, a, c, f)
            })
        }
    });
    ...
    function bJ(a, b) {
        return ai(a, "table") && ai(11 !== b.nodeType ? b : b.firstChild, "tr") && bi(a).children("tbody")[0] || a
    }
    ...
    function bx(c, m) {
        var g, j, d, h, b, k, p, f;
        if (1 === m.nodeType) {
            if (bT.hasData(c) && (h = bT.access(c), b = bT.set(m, h), f = h.events)) {
                for (d in delete b.handle, b.events = {}, f) {
                    for (g = 0, j = f[d].length; g < j; g++) {
                        bi.event.add(m, d, f[d][g])
                    }
                }
            }
    ...
    function a8(x, A, v, y) {
        ...
        if (m && (C = (k = cw(A, x[0].ownerDocument, !1, x, y)).firstChild, 1 === k.childNodes.length && (k = C), C || y)) {
            for (B = (b = bi.map(cp(k, "script"), bP)).length; g < m; g++) {
                D = k, g !== z && (D = bi.clone(D, !0, !0), B && bi.merge(b, cp(D, "script"))), v.call(x[g], D, g)
            }
            if (B) {
                for (w = b[b.length - 1].ownerDocument, bi.map(b, b1), g = 0; g < B; g++) {
                    D = b[g], a1.test(D.type || "") && !bT.access(D, "globalEval") && bi.contains(w, D) && (D.src && "module" !== (D.type || "").toLowerCase() ? bi._evalUrl && !D.noModule && bi._evalUrl(D.src, {
                        nonce: D.nonce || D.getAttribute("nonce")
                    }) : an(D.textContent.replace(a2, ""), D, w))
                }
            }
        }
        return x
    ...
    function cx(a, g, c) {
        for (var f, b = g ? bi.filter(g, a) : a, d = 0; null != (f = b[d]); d++) {
            c || 1 !== f.nodeType || bi.cleanData(cp(f)), f.parentNode && (c && bI(f) && cI(cp(f, "script")), f.parentNode.removeChild(f))
        }
        return a
    }
    bi.extend({
        htmlPrefilter: function(a) {
            return a.replace(bd, "<$1></$2>")
        },
        clone: function(g, w, m) {
            var q, j, p, b, v, x, k, d = g.cloneNode(!0),
                h = bI(g);
            if (!(cG.noCloneChecked || 1 !== g.nodeType && 11 !== g.nodeType || bi.isXMLDoc(g))) {
                for (b = cp(d), q = 0, j = (p = cp(g)).length; q < j; q++) {
                    v = p[q], x = b[q], void 0, "input" === (k = x.nodeName.toLowerCase()) && bO.test(v.type) ? x.checked = v.checked : "input" !== k && "textarea" !== k || (x.defaultValue = v.defaultValue)
                }
            }
            if (w) {
                if (m) {
                    for (p = p || cp(g), b = b || cp(d), q = 0, j = p.length; q < j; q++) {
                        bx(p[q], b[q])
                    }
                } else {
                    bx(g, d)
            ...
            for (var g, c, f, b = bi.event.special, d = 0; void 0 !== (c = a[d]); d++) {
                if (aU(c)) {
                    if (g = c[bT.expando]) {
                        if (g.events) {
                            for (f in g.events) {
                                b[f] ? bi.event.remove(c, f) : bi.removeEvent(c, f, g.handle)
                            }
                        }
                        c[bT.expando] = void 0
                    }
        ...
        text: function(a) {
            return ad(this, function(b) {
                return void 0 === b ? bi.text(this) : this.empty().each(function() {
        ...
        append: function() {
            return a8(this, arguments, function(a) {
                1 !== this.nodeType && 11 !== this.nodeType && 9 !== this.nodeType || bJ(this, a).appendChild(a)
            })
        },
        prepend: function() {
            return a8(this, arguments, function(a) {
        ...
        empty: function() {
            for (var a, b = 0; null != (a = this[b]); b++) {
                1 === a.nodeType && (bi.cleanData(cp(a, !1)), a.textContent = "")
            }
            return this
        },
        clone: function(a, b) {
            return a = null != a && a, b = null == b ? a : b, this.map(function() {
                return bi.clone(this, a, b)
            })
        },
        html: function(a) {
            return ad(this, function(b) {
                ...
                if ("string" == typeof b && !bU.test(b) && !aV[(aD.exec(b) || ["", ""])[1].toLowerCase()]) {
                    ...
                    try {
                        for (; c < d; c++) {
                            1 === (f = this[c] || {}).nodeType && (bi.cleanData(cp(f, !1)), f.innerHTML = b)
                        }
                        f = 0
                    } catch (b) {}
                }
        ...
        bi.fn[c] = function(a) {
            for (var j, f = [], h = bi(a), d = h.length - 1, g = 0; g <= d; g++) {
                j = g === d ? this : this.clone(!0), bi(h[g])[b](j), ch.apply(f, j.get())
            }
    ...
    function af(c, k, f) {
        ...
        return (f = f || aQ(c)) && ("" !== (b = f.getPropertyValue(k) || f[k]) || bI(c) || (b = bi.style(c, k)), !cG.pixelBoxStyles() && ab.test(b) && aq.test(k) && (h = j.width, d = j.minWidth, g = j.maxWidth, j.minWidth = j.maxWidth = j.width = b, b = f.width, j.width = h, j.minWidth = d, j.maxWidth = g)), void 0 !== b ? b + "" : b
    }
    ...
    function cO(a, b) {
        ...
        l.style && (l.style.backgroundClip = "content-box", l.cloneNode(!0).style.backgroundClip = "", cG.clearCloneStyle = "content-box" === l.style.backgroundClip, bi.extend(cG, {
    ...
    function aL(c, k, f, h, d, g) {
        ...
        for (; b < 4; b += 2) {
            "margin" === f && (l += bi.css(c, f + b0[b], !0, d)), h ? ("content" === f && (l -= bi.css(c, "padding" + b0[b], !0, d)), "margin" !== f && (l -= bi.css(c, "border" + b0[b] + "Width", !0, d))) : (l += bi.css(c, "padding" + b0[b], !0, d), "padding" !== f ? l += bi.css(c, "border" + b0[b] + "Width", !0, d) : j += bi.css(c, "border" + b0[b] + "Width", !0, d))
        }
    ...
    function bE(a, f, c, d, b) {
        return new bE.prototype.init(a, f, c, d, b)
    }
    bi.extend({
        cssHooks: {
            opacity: {
        ...
        style: function(c, m, g, j) {
            if (c && 3 !== c.nodeType && 8 !== c.nodeType && c.style) {
                var d, h, b, k = co(m),
                    p = bV.test(m),
                    f = c.style;
                if (p || (m = aW(k)), b = bi.cssHooks[m] || bi.cssHooks[k], void 0 === g) {
        ...
        css: function(c, k, f, h) {
            var d, g, b, j = co(k);
            return bV.test(k) || (k = aW(j)), (b = bi.cssHooks[k] || bi.cssHooks[j]) && "get" in b && (d = b.get(c, !0, f)), void 0 === d && (d = af(c, k, h)), "normal" === d && k in bl && (d = bl[k]), "" === f || f ? (g = parseFloat(d), !0 === f || isFinite(g) ? g || 0 : d) : d
        }
    }), bi.each(["height", "width"], function(a, b) {
        bi.cssHooks[b] = {
            get: function(c, f, d) {
                if (f) {
                    return !cJ.test(bi.css(c, "display")) || c.getClientRects().length && c.getBoundingClientRect().width ? cf(c, b, d) : cj(c, bf, function() {
                        return cf(c, b, d)
                    })
                }
            },
    ...
    }), bi.cssHooks.marginLeft = cO(cG.reliableMarginLeft, function(a, b) {
        if (b) {
            return (parseFloat(af(a, "marginLeft")) || a.getBoundingClientRect().left - cj(a, {
                marginLeft: 0
            }, function() {
        ...
        bi.cssHooks[a + b] = {
            expand: function(c) {
                for (var g = 0, d = {}, f = "string" == typeof c ? c.split(" ") : [c]; g < 4; g++) {
                    d[a + b0[g] + b] = f[g] || f[g - 2] || f[0]
                }
                return d
            }
        }, "margin" !== a && (bi.cssHooks[a + b].set = cP)
    }), bi.fn.extend({
        css: function(a, b) {
            return ad(this, function(d, k, g) {
                var j, f, h = {}, c = 0;
                if (Array.isArray(k)) {
                    for (j = aQ(d), f = k.length; c < f; c++) {
                        h[k[c]] = bi.css(d, k[c], !1, j)
                    }
                    return h
                }
    ...
    }), ((bi.Tween = bE).prototype = {
        constructor: bE,
        init: function(a, g, c, f, b, d) {
            this.elem = a, this.prop = c, this.easing = b || bi.easing._default, this.options = g, this.start = this.now = this.cur(), this.end = f, this.unit = d || (bi.cssNumber[c] ? "" : "px")
        },
        cur: function() {
            var a = bE.propHooks[this.prop];
            return a && a.get ? a.get(this) : bE.propHooks._default.get(this)
        },
        run: function(a) {
            var c, b = bE.propHooks[this.prop];
            return this.options.duration ? this.pos = c = bi.easing[this.easing](a, this.options.duration * a, 0, 1, this.options.duration) : this.pos = c = a, this.now = (this.end - this.start) * c + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), b && b.set ? b.set(this) : bE.propHooks._default.set(this), this
        }
    }).init.prototype = bE.prototype, (bE.propHooks = {
        _default: {
            get: function(a) {
                var b;
                return 1 !== a.elem.nodeType || null != a.elem[a.prop] && null == a.elem.style[a.prop] ? a.elem[a.prop] : (b = bi.css(a.elem, a.prop, "")) && "auto" !== b ? b : 0
            },
            set: function(a) {
                bi.fx.step[a.prop] ? bi.fx.step[a.prop](a) : 1 !== a.elem.nodeType || !bi.cssHooks[a.prop] && null == a.elem.style[aW(a.prop)] ? a.elem[a.prop] = a.now : bi.style(a.elem, a.prop, a.now + a.unit)
            }
        }
        ...
        _default: "swing"
    }, bi.fx = bE.prototype.init, bi.fx.step = {};
    var b2, a9, bK, al, b8 = /^(?:toggle|show|hide)$/,
        cl = /queueHooks$/;

    function br() {
        a9 && (!1 === aI.hidden && aw.requestAnimationFrame ? aw.requestAnimationFrame(br) : aw.setTimeout(br, bi.fx.interval), bi.fx.tick())
    }
    ...
    function aR(a, f) {
        ...
        for (f = f ? 1 : 0; d < 4; d += 2 - f) {
            b["margin" + (c = b0[d])] = b["padding" + c] = a
        }
        return f && (b.opacity = b.width = a), b
    }

    function bQ(c, j, f) {
        for (var h, d = (aF.tweeners[j] || []).concat(aF.tweeners["*"]), g = 0, b = d.length; g < b; g++) {
            if (h = d[g].call(f, j, c)) {
                return h
            }
        }
    ...
    function aF(k, f, q) {
        var j, b, m = 0,
            ...
            v = function() {
                ...
                for (var a = b2 || az(), s = Math.max(0, h.startTime + h.duration - a), l = 1 - (s / h.duration || 0), o = 0, c = h.tweens.length; o < c; o++) {
                    h.tweens[o].run(l)
                }
                ...
                createTween: function(a, i) {
                    var c = bi.Tween(k, h.opts, a, i, h.opts.specialEasing[a] || h.opts.easing);
        ...
        for (! function(l, y) {
            var u, x, s, w, c;
            for (u in l) {
                if (s = y[x = co(u)], w = l[u], Array.isArray(w) && (s = w[1], w = l[u] = w[0]), u !== x && (l[x] = w, delete l[u]), (c = bi.cssHooks[x]) && "expand" in c) {
            ...
            if (j = aF.prefilters[m].call(h, k, d, h.opts)) {
                return bu(j.stop) && (bi._queueHooks(h.elem, h.opts.queue).stop = j.stop.bind(j)), j
            }
        }
        return bi.map(d, bQ, h), bu(h.opts.start) && h.opts.start.call(k, h), h.progress(h.opts.progress).done(h.opts.done, h.opts.complete).fail(h.opts.fail).always(h.opts.always), bi.fx.timer(bi.extend(v, {
            elem: k,
            anim: h,
            queue: h.opts.queue
        })), h
    ...
    bi.Animation = bi.extend(aF, {
        tweeners: {
            "*": [
                function(a, c) {
                    ...
                    return bp(b.elem, a, bC.exec(c), b), b
                }
            ]
        },
        tweener: function(a, f) {
            bu(a) ? (f = a, a = ["*"]) : a = a.match(bZ);
            for (var c, d = 0, b = a.length; d < b; d++) {
                c = a[d], aF.tweeners[c] = aF.tweeners[c] || [], aF.tweeners[c].unshift(f)
            }
        },
        prefilters: [
            function(m, F, A) {
                var D, y, B, b, E, G, z, j, q = "width" in F || "height" in F,
                    ...
                    w = m.nodeType && b6(m),
                    H = bT.get(m, "fxshow");
                for (D in A.queue || (null == (b = bi._queueHooks(m, "fx")).unqueued && (b.unqueued = 0, E = b.empty.fire, b.empty.fire = function() {
                    b.unqueued || E()
                }), b.unqueued++, C.always(function() {
                    C.always(function() {
                        b.unqueued--, bi.queue(m, "fx").length || b.empty.fire()
                    })
                })), F) {
                    if (y = F[D], b8.test(y)) {
                ...
                if ((G = !bi.isEmptyObject(F)) || !bi.isEmptyObject(k)) {
                    for (D in q && 1 === m.nodeType && (A.overflow = [x.overflow, x.overflowX, x.overflowY], null == (z = H && H.display) && (z = bT.get(m, "display")), "none" === (j = bi.css(m, "display")) && (z ? j = z : (aP([m], !0), z = m.style.display || z, j = bi.css(m, "display"), aP([m]))), ("inline" === j || "inline-block" === j && null != z) && "none" === bi.css(m, "float") && (G || (C.done(function() {
                        x.display = z
                        ...
                        G || (H ? "hidden" in H && (w = H.hidden) : H = bT.access(m, "fxshow", {
                            display: z
                        }), B && (H.hidden = !w), w && aP([m], !0), C.done(function() {
                            for (D in w || aP([m]), bT.remove(m, "fxshow"), k) {
                                bi.style(m, D, k[D])
                            }
                        })), G = bQ(w ? H[D] : 0, D, C), D in H || (H[D] = G.start, w && (G.end = G.start, G.start = 0))
                    }
                }
            }
        ],
        prefilter: function(a, b) {
            b ? aF.prefilters.unshift(a) : aF.prefilters.push(a)
        }
    }), bi.speed = function(a, d, b) {
        var c = a && "object" == typeof a ? bi.extend({}, a) : {
            complete: b || !b && d || bu(a) && a,
            duration: a,
            easing: b && d || d && !bu(d) && d
        };
        return bi.fx.off ? c.duration = 0 : "number" != typeof c.duration && (c.duration in bi.fx.speeds ? c.duration = bi.fx.speeds[c.duration] : c.duration = bi.fx.speeds._default), null != c.queue && !0 !== c.queue || (c.queue = "fx"), c.old = c.complete, c.complete = function() {
            bu(c.old) && c.old.call(this), c.queue && bi.dequeue(this, c.queue)
        }, c
    }, bi.fn.extend({
        fadeTo: function(a, d, b, c) {
            return this.filter(b6).css("opacity", 0).show().end().animate({
                opacity: d
            }, a, b, c)
        },
        ...
        finish: function(b) {
            return !1 !== b && (b = b || "fx"), this.each(function() {
                var a, h = bT.get(this),
                    ...
                    c = bi.timers,
                    f = d ? d.length : 0;
                for (h.finish = !0, bi.queue(this, b, []), g && g.stop && g.stop.call(this, !0), a = c.length; a--;) {
        ...
        var b = bi.fn[c];
        bi.fn[c] = function(d, g, f) {
            return null == d || "boolean" == typeof d ? b.apply(this, arguments) : this.animate(aR(c, !0), d, g, f)
        }
    }), bi.each({
        slideDown: aR("show"),
        slideUp: aR("hide"),
        ...
        bi.fn[a] = function(c, f, d) {
            return this.animate(b, c, f, d)
        }
    }), bi.timers = [], bi.fx.tick = function() {
        var a, c = 0,
            b = bi.timers;
    ...
    }, bi.fx.timer = function(a) {
        bi.timers.push(a), bi.fx.start()
    }, bi.fx.interval = 13, bi.fx.start = function() {
        a9 || (a9 = !0, br())
    }, bi.fx.stop = function() {
        a9 = null
    }, bi.fx.speeds = {
    ...
    bi.fn.extend({
        attr: function(a, b) {
            return ad(this, bi.attr, a, b, 1 < arguments.length)
        },
        removeAttr: function(a) {
            return this.each(function() {
                bi.removeAttr(this, a)
            })
        }
    }), bi.extend({
        attr: function(a, g, c) {
            ...
            if (3 !== d && 8 !== d && 2 !== d) {
                return "undefined" == typeof a.getAttribute ? bi.prop(a, g, c) : (1 === d && bi.isXMLDoc(a) || (b = bi.attrHooks[g.toLowerCase()] || (bi.expr.match.bool.test(g) ? a3 : void 0)), void 0 !== c ? null === c ? void bi.removeAttr(a, g) : b && "set" in b && void 0 !== (f = b.set(a, c, g)) ? f : (a.setAttribute(g, c + ""), c) : b && "get" in b && null !== (f = b.get(a, g)) ? f : null == (f = bi.find.attr(a, g)) ? void 0 : f)
            }
        },
        attrHooks: {
            type: {
                set: function(a, c) {
                    if (!cG.radioValue && "radio" === c && ai(a, "input")) {
                        var b = a.value;
        ...
        set: function(a, c, b) {
            return !1 === c ? bi.removeAttr(a, b) : a.setAttribute(b, b), b
        }
    }, bi.each(bi.expr.match.bool.source.match(/\w+/g), function(c, d) {
        var b = aX[d] || bi.find.attr;
        aX[d] = function(a, k, g) {
            var j, f, h = k.toLowerCase();
            return g || (f = aX[h], aX[h] = j, j = null != b(a, k, g) ? h : null, aX[h] = f), j
        }
    });
    ...
    function ar(a) {
        return Array.isArray(a) ? a : "string" == typeof a && a.match(bZ) || []
    }
    bi.fn.extend({
        prop: function(a, b) {
            return ad(this, bi.prop, a, b, 1 < arguments.length)
        },
        removeProp: function(a) {
            return this.each(function() {
                delete this[bi.propFix[a] || a]
            })
        }
    }), bi.extend({
        prop: function(a, g, c) {
            var f, b, d = a.nodeType;
            if (3 !== d && 8 !== d && 2 !== d) {
                return 1 === d && bi.isXMLDoc(a) || (g = bi.propFix[g] || g, b = bi.propHooks[g]), void 0 !== c ? b && "set" in b && void 0 !== (f = b.set(a, c, g)) ? f : a[g] = c : b && "get" in b && null !== (f = b.get(a, g)) ? f : a[g]
            }
        },
        propHooks: {
            tabIndex: {
                get: function(a) {
                    var b = bi.find.attr(a, "tabindex");
                    return b ? parseInt(b, 10) : cr.test(a.nodeName) || cK.test(a.nodeName) && a.href ? 0 : -1
                }
            }
        },
        propFix: {
    ...
    }), cG.optSelected || (bi.propHooks.selected = {
        get: function(a) {
            var b = a.parentNode;
        ...
        addClass: function(k) {
            ...
            if (bu(k)) {
                return this.each(function(a) {
                    bi(this).addClass(k.call(this, a, cE(this)))
                })
            }
            if ((c = ar(k)).length) {
                while (f = this[l++]) {
        ...
        removeClass: function(k) {
            ...
            if (bu(k)) {
                return this.each(function(a) {
                    bi(this).removeClass(k.call(this, a, cE(this)))
                })
            }
            if (!arguments.length) {
        ...
        toggleClass: function(c, e) {
            ...
            return "boolean" == typeof e && b ? e ? this.addClass(c) : this.removeClass(c) : bu(c) ? this.each(function(a) {
                bi(this).toggleClass(c.call(this, a, cE(this), e), e)
            }) : this.each(function() {
                var a, h, f, g;
                if (b) {
                    h = 0, f = bi(this), g = ar(c);
                    while (a = g[h++]) {
                        f.hasClass(a) ? f.removeClass(a) : f.addClass(a)
                    }
                } else {
                    void 0 !== c && "boolean" !== d || ((a = cE(this)) && bT.set(this, "__className__", a), this.setAttribute && this.setAttribute("class", a || !1 === c ? "" : bT.get(this, "__className__") || ""))
                }
            })
        },
        hasClass: function(a) {
            ...
            d = " " + a + " ";
            while (b = this[c++]) {
                if (1 === b.nodeType && -1 < (" " + by(cE(b)) + " ").indexOf(d)) {
                    return !0
                }
            }
            return !1
    ...
    bi.fn.extend({
        val: function(c) {
            ...
            return arguments.length ? (b = bu(c), this.each(function(g) {
                var h;
                1 === this.nodeType && (null == (h = b ? c.call(this, g, bi(this).val()) : c) ? h = "" : "number" == typeof h ? h += "" : Array.isArray(h) && (h = bi.map(h, function(i) {
                    return null == i ? "" : i + ""
                })), (d = bi.valHooks[this.type] || bi.valHooks[this.nodeName.toLowerCase()]) && "set" in d && void 0 !== d.set(this, h, "value") || (this.value = h))
        ...
        valHooks: {
            option: {
                get: function(a) {
                    var b = bi.find.attr(a, "value");
                    return null != b ? b : by(bi.text(a))
                }
            },
            select: {
                get: function(c) {
        ...
        bi.valHooks[this] = {
            set: function(a, b) {
                if (Array.isArray(b)) {
                    return a.checked = -1 < bi.inArray(bi(a).val(), b)
                }
            }
        }, cG.checkOn || (bi.valHooks[this].get = function(a) {
            return null === a.getAttribute("value") ? "on" : a.value
        })
    }), cG.focusin = "onfocusin" in aw;
    ...
    bi.extend(bi.event, {
        trigger: function(k, C, x, A) {
            ...
            if (y = m = b = x = x || aI, 3 !== x.nodeType && 8 !== x.nodeType && !cg.test(j + bi.event.triggered) && (-1 < j.indexOf(".") && (j = (q = j.split(".")).shift(), q.sort()), D = j.indexOf(":") < 0 && "on" + j, (k = k[bi.expando] ? k : new bi.Event(j, "object" == typeof k && k)).isTrigger = A ? 2 : 3, k.namespace = q.join("."), k.rnamespace = k.namespace ? new RegExp("(^|\\.)" + q.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, k.result = void 0, k.target || (k.target = x), C = null == C ? [k] : bi.makeArray(C, [k]), g = bi.event.special[j] || {}, A || !g.trigger || !1 !== g.trigger.apply(x, C))) {
                if (!A && !g.noBubble && !cA(x)) {
                    for (B = g.delegateType || j, cg.test(B + j) || (y = y.parentNode); y; y = y.parentNode) {
                        z.push(y), b = y
                    }
                ...
                while ((y = z[v++]) && !k.isPropagationStopped()) {
                    m = y, k.type = 1 < v ? B : g.bindType || j, (w = (bT.get(y, "events") || {})[k.type] && bT.get(y, "handle")) && w.apply(y, C), (w = D && y[D]) && w.apply && aU(y) && (k.result = w.apply(y, C), !1 === k.result && k.preventDefault())
                }
        ...
        simulate: function(a, d, b) {
            var c = bi.extend(new bi.Event, b, {
                type: a,
                isSimulated: !0
            });
        ...
        trigger: function(a, b) {
            return this.each(function() {
                bi.event.trigger(a, b, this)
            })
        },
        triggerHandler: function(a, c) {
            var b = this[0];
            if (b) {
                return bi.event.trigger(a, c, b, !0)
            }
        }
    }), cG.focusin || bi.each({
        focus: "focusin",
        ...
        var a = function(d) {
            bi.event.simulate(c, d.target, bi.event.fix(d))
        };
        bi.event.special[c] = {
            setup: function() {
    ...
    bi.parseXML = function(a) {
        ...
        return b && !b.getElementsByTagName("parsererror").length || bi.error("Invalid XML: " + a), b
    };
    var bF = /\[\]$/,
        am = /\r?\n/g,
    ...
    function bW(c, a, d, b) {
        var f;
        if (Array.isArray(a)) {
            bi.each(a, function(g, h) {
                d || bF.test(c) ? b(c, h) : bW(c + "[" + ("object" == typeof h && null != h ? g : "") + "]", h, d, b)
            })
        } else {
            if (d || "object" !== cu(a)) {
                b(c, a)
    ...
    bi.param = function(a, f) {
        ...
        if (Array.isArray(a) || a.jquery && !bi.isPlainObject(a)) {
            bi.each(a, function() {
        ...
        serializeArray: function() {
            return this.map(function() {
                var a = bi.prop(this, "elements");
                return a ? bi.makeArray(a) : this
            }).filter(function() {
                var a = this.type;
                return this.name && !bi(this).is(":disabled") && bg.test(this.nodeName) && !aG.test(a) && (this.checked || !bO.test(a))
            }).map(function(a, c) {
                var b = bi(this).val();
                return null == b ? null : Array.isArray(b) ? bi.map(b, function(d) {
                    return {
                        name: c.name,
                        value: d.replace(am, "\r\n")
                    }
    ...
    function ag(g, c, e, b) {
        ...
        function d(a) {
            var i;
            return f[a] = !0, bi.each(g[a] || [], function(j, l) {
                var k = l(c, e, b);
    ...
    function cQ(a, f) {
        var c, d, b = bi.ajaxSettings.flatOptions || {};
        for (c in f) {
            void 0 !== f[c] && ((b[c] ? a : d || (d = {}))[c] = f[c])
        }
        return d && bi.extend(!0, a, d), a
    }
    aS.href = aM.href, bi.extend({
        ...
        ajaxSettings: {
            url: aM.href,
            type: "GET",
            isLocal: /^(?:about|app|app-storage|.+-extension|file|res|widget):$/.test(aM.protocol),
            global: !0,
            processData: !0,
            async: !0,
        ...
        ajaxSetup: function(a, b) {
            return b ? cQ(cQ(a, bi.ajaxSettings), b) : cQ(bi.ajaxSettings, a)
        },
        ajaxPrefilter: au(ba),
        ajaxTransport: au(cz),
        ajax: function(A, M) {
        ...
        getJSON: function(a, c, b) {
            return bi.get(a, c, b, "json")
        },
        getScript: function(a, b) {
            return bi.get(a, void 0, b, "script")
        }
    }), bi.each(["get", "post"], function(a, b) {
        bi[b] = function(c, g, d, f) {
            return bu(g) && (f = f || d, d = g, g = void 0), bi.ajax(bi.extend({
                url: c,
                type: b,
                dataType: f,
                data: g,
                success: d
            }, bi.isPlainObject(c) && c))
        }
    }), bi._evalUrl = function(a, b) {
        return bi.ajax({
            url: a,
            type: "GET",
            dataType: "script",
        ...
        wrapAll: function(a) {
            var b;
            return this[0] && (bu(a) && (a = a.call(this[0])), b = bi(a, this[0].ownerDocument).eq(0).clone(!0), this[0].parentNode && b.insertBefore(this[0]), b.map(function() {
                var c = this;
        ...
        wrapInner: function(a) {
            return bu(a) ? this.each(function(b) {
                bi(this).wrapInner(a.call(this, b))
            }) : this.each(function() {
                var b = bi(this),
                    c = b.contents();
        ...
        wrap: function(b) {
            ...
            return this.each(function(c) {
                bi(this).wrapAll(a ? b.call(this, c) : b)
            })
        },
        unwrap: function(a) {
    ...
    }), bi.expr.pseudos.hidden = function(a) {
        return !bi.expr.pseudos.visible(a)
    }, bi.expr.pseudos.visible = function(a) {
        return !!(a.offsetWidth || a.offsetHeight || a.getClientRects().length)
    }, bi.ajaxSettings.xhr = function() {
        try {
    ...
    cG.cors = !! cF && "withCredentials" in cF, cG.ajax = cF = !! cF, bi.ajaxTransport(function(c) {
        ...
        if (cG.cors || cF && !c.crossDomain) {
            return {
                send: function(a, h) {
                    ...
                    d = function(i) {
                        return function() {
                            d && (d = b = g.onload = g.onerror = g.onabort = g.ontimeout = g.onreadystatechange = null, "abort" === i ? g.abort() : "error" === i ? "number" != typeof g.status ? h(0, "error") : h(g.status, g.statusText) : h(cm[g.status] || g.status, g.statusText, "text" !== (g.responseType || "text") || "string" != typeof g.responseText ? {
                                binary: g.response
                            } : {
                                text: g.responseText
        ...
        converters: {
            "text script": function(a) {
                return bi.globalEval(a), a
            }
        }
    }), bi.ajaxPrefilter("script", function(a) {
        void 0 === a.cache && (a.cache = !1), a.crossDomain && (a.type = "GET")
    }), bi.ajaxTransport("script", function(b) {
        var c, a;
        if (b.crossDomain || b.scriptAttrs) {
            return {
                send: function(d, f) {
                    c = bi("<script>").attr(b.scriptAttrs || {}).prop({
    ...
    bi.ajaxSetup({
        ...
        jsonpCallback: function() {
            var a = aY.pop() || bi.expando + "_" + bm++;
            return this[a] = !0, a
        }
    }), bi.ajaxPrefilter("json jsonp", function(c, j, f) {
        var h, d, g, b = !1 !== c.jsonp && (cL.test(c.url) ? "url" : "string" == typeof c.data && 0 === (c.contentType || "").indexOf("application/x-www-form-urlencoded") && cL.test(c.data) && "data");
        if (b || "jsonp" === c.dataTypes[0]) {
            return h = c.jsonpCallback = bu(c.jsonpCallback) ? c.jsonpCallback() : c.jsonpCallback, b ? c[b] = c[b].replace(cL, "$1" + h) : !1 !== c.jsonp && (c.url += (b9.test(c.url) ? "&" : "?") + c.jsonp + "=" + h), c.converters["script json"] = function() {
                return g || bi.error(h + " was not called"), g[0]
            }, c.dataTypes[0] = "json", d = aw[h], aw[h] = function() {
                g = arguments
            }, f.always(function() {
                void 0 === d ? bi(aw).removeProp(h) : aw[h] = d, c[h] && (c.jsonpCallback = j.jsonpCallback, aY.push(h)), g && bu(d) && d(g[0]), g = d = void 0
            }), "script"
        }
    }), cG.createHTMLDocument = ((cs = aI.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === cs.childNodes.length), bi.parseHTML = function(a, g, c) {
        return "string" != typeof a ? [] : ("boolean" == typeof g && (c = g, g = !1), g || (cG.createHTMLDocument ? ((f = (g = aI.implementation.createHTMLDocument("")).createElement("base")).href = aI.location.href, g.head.appendChild(f)) : g = aI), d = !c && [], (b = aC.exec(a)) ? [g.createElement(b[1])] : (b = cw([a], g, d), d && d.length && bi(d).remove(), bi.merge([], b.childNodes)));
        var f, b, d
    }, bi.fn.load = function(c, k, f) {
        var h, d, g, b = this,
            j = c.indexOf(" ");
        return -1 < j && (h = by(c.slice(j)), c = c.slice(0, j)), bu(k) ? (f = k, k = void 0) : k && "object" == typeof k && (d = "POST"), 0 < b.length && bi.ajax({
            url: c,
            type: d || "GET",
            dataType: "html",
            data: k
        }).done(function(a) {
            g = arguments, b.html(h ? bi("<div>").append(bi.parseHTML(a)).find(h) : a)
        }).always(f && function(a, i) {
            b.each(function() {
                f.apply(this, g || [a.responseText, i, a])
            })
        }), this
    }, bi.each(["ajaxStart", "ajaxStop", "ajaxComplete", "ajaxError", "ajaxSuccess", "ajaxSend"], function(a, b) {
        bi.fn[b] = function(c) {
            return this.on(b, c)
        }
    }), bi.expr.pseudos.animated = function(a) {
        return bi.grep(bi.timers, function(b) {
            return a === b.elem
        }).length
    }, bi.offset = {
        ...
        offsetParent: function() {
            return this.map(function() {
                ...
                while (a && "static" === bi.css(a, "position")) {
                    a = a.offsetParent
                }
                return a || a7
            })
        ...
        bi.fn[c] = function(d) {
            return ad(this, function(f, i, g) {
                var h;
                if (cA(f) ? h = f : 9 === f.nodeType && (h = f.defaultView), void 0 === g) {
                    return h ? h[a] : f[i]
                }
                h ? h.scrollTo(b ? h.pageXOffset : g, b ? g : h.pageYOffset) : f[i] = g
            }, c, d, arguments.length)
        }
    }), bi.each(["top", "left"], function(a, b) {
        bi.cssHooks[b] = cO(cG.pixelPosition, function(c, d) {
            if (d) {
                return d = af(c, b), ab.test(d) ? bi(c).position()[b] + "px" : d
            }
        })
    }), bi.each({
        Height: "height",
        ...
        bi.each({
            ...
            bi.fn[a] = function(f, j) {
                ...
                return ad(this, function(i, m, k) {
                    var l;
                    return cA(i) ? 0 === a.indexOf("outer") ? i["inner" + b] : i.document.documentElement["client" + b] : 9 === i.nodeType ? (l = i.documentElement, Math.max(i.body["scroll" + b], l["scroll" + b], i.body["offset" + b], l["offset" + b], l["client" + b])) : void 0 === k ? bi.css(i, m, g) : bi.style(i, m, k, g)
                }, c, h ? f : void 0, h)
            }
        })
    }), bi.each("blur focus focusin focusout resize scroll click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup contextmenu".split(" "), function(a, b) {
        bi.fn[b] = function(c, d) {
    ...
    }), bi.proxy = function(a, f) {
        var c, d, b;
        if ("string" == typeof f && (c = a[f], f = a, a = c), bu(a)) {
            return d = b4.call(arguments, 2), (b = function() {
                return a.apply(f || this, d.concat(b4.call(arguments)))
            }).guid = a.guid = a.guid || bi.guid++, b
        }
    }, bi.holdReady = function(a) {
        a ? bi.readyWait++ : bi.ready(!0)
    }, bi.isArray = Array.isArray, bi.parseJSON = JSON.parse, bi.nodeName = ai, bi.isFunction = bu, bi.isWindow = cA, bi.camelCase = co, bi.type = cu, bi.now = Date.now, bi.isNumeric = function(a) {
        var b = bi.type(a);
    ...
    var bX = aw.jQuery,
        bh = aw.$;
    return bi.noConflict = function(a) {
        return aw.$ === bi && (aw.$ = bh), a && aw.jQuery === bi && (aw.jQuery = bX), bi
    }, aH || (aw.jQuery = aw.$ = bi), bi
});